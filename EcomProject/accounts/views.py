...
def edit_coupon_offer(request, coupon_id):
    ...
    return render(request, 'admin/coupon-offer-update.html', {'form': form, 'coupon_id': coupon_id})
...
def add_offer_percentage(request, product_id):
    ...
    return render(request, 'admin/add-product-offer.html', {'form': form, 'product_id': product_id})
...
def my_profile(request):
    ...
    if userprofile:
        ...
        context = {'user_data': user_data, 'profile_data': profile_data, 'userprofile': userprofile}
